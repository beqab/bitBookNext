...
import InvestAndEarn from "../components/userProfile/investAndEarn";
          ...
          <div className="col-9">
            <div className=" userProfile_container ">
              {activeMenu === "Invest & Earn" ? (
                ...
                <>
                  <div className="userProfile_title">{activeMenu}</div>
                </>
              )}
            </div>
          </div>
