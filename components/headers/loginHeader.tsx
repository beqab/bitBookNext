...
// import {ReactComoen Logo} from "../../public/img/logo.svg";
...
const Logo = () => (
  ...
  >
    ...
    <g transform="translate(-79 -20)">
      ...
      />
      <path className="a" d="M160.227,38.8H157.1V53.71h3.132Z" />
      <path
        className="a"
        d="M158.661,32.646a2.005,2.005,0,0,0-1.439.5,1.67,1.67,0,0,0-.55,1.3,1.528,1.528,0,0,0,.55,1.256,2.076,2.076,0,0,0,1.439.5,2.187,2.187,0,0,0,1.482-.5,1.584,1.584,0,0,0,.55-1.256,1.67,1.67,0,0,0-.55-1.3A2.187,2.187,0,0,0,158.661,32.646Z"
      />
      <path
        className="a"
        d="M168.4,50.569a2.443,2.443,0,0,1-.466-1.759V41.44h3.64V38.8h-3.64V35.075H164.8V38.8H162.64V41.44H164.8v7.328a5.206,5.206,0,0,0,1.227,3.853,4.989,4.989,0,0,0,3.64,1.131h1.9v-2.68h-1.524A2.408,2.408,0,0,1,168.4,50.569Z"
      />
      <path
        className="a"
